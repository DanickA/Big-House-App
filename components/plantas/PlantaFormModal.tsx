      ...
      <div className="relative glass-modal w-full max-w-xl rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col my-auto max-h-[calc(100vh-3.5rem)] border border-white/80 dark:border-white/10 animate-fade-in-up">
        ...
        <div className="flex justify-between items-center px-6 sm:px-8 py-5 border-b border-[#E8E0D2]/80 dark:border-separator bg-white/85 dark:bg-[#1C1F1A]/85 backdrop-blur-md shrink-0">
          <div className="flex items-center gap-3.5">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-[#EEF2EA] to-[#DCE7D3] dark:from-[#282C25] dark:to-[#1C1F1A] border border-[#B7CBA9]/60 dark:border-separator text-[#3A4630] dark:text-olive flex items-center justify-center shadow-2xs">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div
                ...
                className="relative h-44 rounded-3xl border-2 border-dashed border-[#B7CBA9]/80 dark:border-separator bg-white/40 dark:bg-tertiary/40 hover:bg-white/70 dark:hover:bg-tertiary/70 transition-all duration-300 flex flex-col items-center justify-center cursor-pointer overflow-hidden group shadow-2xs"
              >
                {fotoPreview ? (
                  <>
                    <img
                    ...
                    <div className="absolute inset-0 bg-black/35 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <span className="px-4 py-2 bg-white/90 dark:bg-secondary backdrop-blur-md rounded-2xl text-xs font-bold text-[#3A4630] dark:text-label-primary flex items-center gap-1.5 shadow-md">
                        <RefreshCw size={13} />
                  ...
                  <div className="text-center p-4 space-y-2">
                    <div className="w-12 h-12 rounded-2xl bg-[#EEF2EA] dark:bg-[#282C25] border border-[#DCE7D3] dark:border-separator text-olive flex items-center justify-center mx-auto group-hover:scale-110 transition shadow-2xs">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 flex-wrap pt-2">
                <span className="text-[10px] font-bold text-label-secondary uppercase tracking-wider mr-1">
                  Sugerencias:
                </span>
                  ...
                  <button
                    ...
                    className={`px-2.5 py-1 rounded-xl text-[11px] font-semibold transition cursor-pointer active:scale-95 ${
                      ubicacion === lugar
                        ...
                        : 'bg-white/70 dark:bg-tertiary/60 hover:bg-white dark:hover:bg-tertiary text-label-secondary border border-[#E8E0D2] dark:border-separator'
                    }`}
                  >
                    {lugar}
                  </button>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white/80 dark:bg-tertiary/60 border border-[#D9CEBC] dark:border-separator rounded-2xl text-sm text-[#191C16] dark:text-label-primary font-medium placeholder-[#A39E95] dark:placeholder-label-tertiary focus:outline-none focus:bg-white dark:focus:bg-tertiary focus:border-[#3A4630] dark:focus:border-olive focus:ring-3 focus:ring-[#5F6F52]/15 transition shadow-2xs italic"
                />
              </div>
            </div>

            {/* 5. FRECUENCIA DE RIEGO INTERACTIVA CON STEPPER Y PREVIEW */}
            <div className="p-4.5 bg-white/75 dark:bg-tertiary/40 rounded-3xl border border-white/90 dark:border-white/10 space-y-3.5 shadow-xs">
              <div className="flex items-center justify-between">
                <div>
                  <label className="block text-xs font-extrabold uppercase tracking-wider text-[#3A4630] dark:text-label-primary flex items-center gap-1.5">
                    <Droplets size={14} className="text-olive" />
                ...
                <div className="flex items-center gap-2 bg-[#EEF2EA]/90 dark:bg-secondary px-3 py-1.5 rounded-2xl border border-[#DCE7D3] dark:border-separator shadow-2xs">
                  <span className="text-[10px] font-extrabold text-[#3A4630] dark:text-label-primary">Previsualización:</span>
                  <WaterProgressRing
              ...
              <div className="flex items-center justify-between gap-3 bg-white dark:bg-secondary p-2 rounded-2xl border border-[#D9CEBC] dark:border-separator">
                <button
                  type="button"
                  onClick={handleDecrementarFrecuencia}
                  aria-label="Disminuir frecuencia de riego"
                  className="touch-target w-10 h-10 rounded-xl bg-[#F4EFE6] dark:bg-tertiary hover:bg-[#E8E0D2] dark:hover:bg-tertiary/80 text-[#3A4630] dark:text-label-primary flex items-center justify-center transition cursor-pointer active:scale-90"
                >
                  <Minus size={16} strokeWidth={2.5} />
                </button>

                <div className="text-center">
                  <span className="text-lg font-black text-[#3A4630] dark:text-label-primary">
