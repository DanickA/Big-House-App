...
export default function BottomTabBar() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-auto max-w-sm w-full bg-[#FDFBF7]/90 dark:bg-[#1C1F1A]/92 backdrop-blur-2xl rounded-full px-2 py-1.5 flex items-center justify-around shadow-2xl border border-[rgba(232,224,210,0.9)] dark:border-[rgba(255,255,255,0.14)] transform-gpu">
        {TAB_ITEMS.map((tab) => {
          ...
          return (
            <Link
              ...
              className={`min-w-[54px] min-h-[44px] px-2.5 py-1 rounded-full flex flex-col items-center justify-center gap-0.5 text-[10px] transition-all duration-150 cursor-pointer active:scale-95 touch-manipulation select-none ${
                active
