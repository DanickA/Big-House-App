...
export default function Loading() {
  return (
    <div className="relative min-h-[80vh] p-4 sm:p-6 md:p-10 overflow-hidden select-none">
      ...
      <div className="ambient-glow-mint top-[-40px] left-[-40px] opacity-50" />
      <div className="ambient-glow-terracotta bottom-[20%] right-[-40px] opacity-40" />

      <div className="relative z-10 max-w-5xl mx-auto space-y-6">
        {/* Skeleton Header */}
        <div className="space-y-2">
          <div className="w-28 h-3.5 rounded-full bg-label-secondary/15 dark:bg-white/10 animate-pulse" />
          <div className="w-48 sm:w-64 h-8 rounded-2xl bg-mint/20 dark:bg-white/10 animate-pulse" />
          <div className="w-36 h-3 rounded-full bg-label-secondary/15 dark:bg-white/10 animate-pulse" />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 pt-2">
          <div className="glass-card rounded-3xl p-6 h-48 flex flex-col justify-between animate-pulse">
            <div className="flex items-center justify-between">
              <div className="w-10 h-10 rounded-2xl bg-mint/20 dark:bg-white/10" />
              <div className="w-16 h-4 rounded-full bg-label-secondary/15 dark:bg-white/10" />
            </div>
            <div className="space-y-2">
              <div className="w-3/4 h-5 rounded-xl bg-label-secondary/20 dark:bg-white/10" />
              <div className="w-1/2 h-3.5 rounded-full bg-label-secondary/15 dark:bg-white/10" />
            </div>
          </div>

          <div className="glass-card rounded-3xl p-6 h-48 flex flex-col justify-between animate-pulse">
            <div className="flex items-center justify-between">
              <div className="w-10 h-10 rounded-2xl bg-terracotta/20 dark:bg-white/10" />
              <div className="w-16 h-4 rounded-full bg-label-secondary/15 dark:bg-white/10" />
            </div>
            <div className="space-y-2">
              <div className="w-3/4 h-5 rounded-xl bg-label-secondary/20 dark:bg-white/10" />
          ...
          <div className="glass-card rounded-3xl p-6 h-48 sm:col-span-2 lg:col-span-1 flex flex-col justify-between animate-pulse">
            <div className="flex items-center justify-between">
              <div className="w-10 h-10 rounded-2xl bg-brand-deep/20 dark:bg-white/10" />
